package com.wjx.mvprxjavaretrofitrxlifecycle.utils;
...
import com.wjx.mvprxjavaretrofitrxlifecycle.MyApplication;
...
public final class SpanUtil {
     ...
     * @return the single {@link SpanUtil} instance
     */
    public SpanUtil setAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link SpanUtil} instance
     */
    public SpanUtil appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link SpanUtil} instance
     */
    public SpanUtil appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link SpanUtil} instance
     */
    public SpanUtil appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
